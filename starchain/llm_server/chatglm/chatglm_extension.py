...
class ChatGLM(LLM):
    ...
    endpoint_url: str = "http://127.0.0.1:4002"
    """Endpoint URL to use."""
    ...
    #def __init__(self, host='127.0.0.1', service_type='online'):
    #    """
    #    service_type: online: 4002, local: 4001, default: online
    #    """
    #    port = 4002 if service_type == 'online' else 4001
