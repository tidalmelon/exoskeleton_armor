...
def main():
    ...
    # vector store 路径
    #vs_path = '/home/10170464/jupyter-notebook/Wangquanjun/langchain-ChatGLM/knowledge_base/knowledge_base/faiss_llm_news'
    vs_path = None
    while not vs_path:
        #print("注意输入的路径是完整的文件路径，例如knowledge_base/`knowledge_base_id`/content/file.md，多个路径用英文逗号分割")
        #filepath = input("Input your local knowledge file path 请输入本地知识文件路径：")

        filepath = "/home/10170464/jupyter-notebook/Wangquanjun/langchain-ChatGLM/input_data/state_of_chinese.txt"
